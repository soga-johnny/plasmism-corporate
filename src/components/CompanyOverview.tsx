      ...
      <div className="space-y-8 md:space-y-10">
        <div className="border-b border-[var(--foreground)]/10 pb-6">
          <div className="flex flex-col md:flex-row">
            <div className="w-full md:w-[120px] text-[var(--foreground)]/60 font-thin text-lg md:text-base mb-2 md:mb-0">会社名</div>
        ...
        <div className="border-b border-[var(--foreground)]/10 pb-6">
          <div className="flex flex-col md:flex-row md:items-start">
            <div className="w-full md:w-[120px] text-[var(--foreground)]/60 font-thin text-lg md:text-base mb-2 md:mb-0">所在地</div>
            <div className="hidden md:block text-xl">：</div>
        ...
        <div className="border-b border-[var(--foreground)]/10 pb-6">
          <div className="flex flex-col md:flex-row">
            <div className="w-full md:w-[120px] text-[var(--foreground)]/60 font-thin text-lg md:text-base mb-2 md:mb-0">設立</div>
            <div className="hidden md:block text-xl">：</div>
        ...
        <div className="border-b border-[var(--foreground)]/10 pb-6">
          <div className="flex flex-col md:flex-row">
            <div className="w-full md:w-[120px] text-[var(--foreground)]/60 font-thin text-lg md:text-base mb-2 md:mb-0">代表取締役</div>
            <div className="hidden md:block text-xl">：</div>
        ...
        <div className="border-b border-[var(--foreground)]/10 pb-6">
          <div className="flex flex-col md:flex-row md:items-start">
            <div className="w-full md:w-[120px] text-[var(--foreground)]/60 font-thin text-lg md:text-base mb-2 md:mb-0">事業内容</div>
            <div className="hidden md:block text-xl">：</div>
